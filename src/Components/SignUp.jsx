...
import '../Style/SignUp.css'; // Ensure the path to your CSS file is correct
            ...
            <div className="container position-relative">
                <div className="row justify-content-center">
                    <div className="col-xl-6">
                        ...
                        <form className="form-subscribe" id="contactFormFooter" data-sb-form-api-token="API_TOKEN" onSubmit={handleSubmit}>
                            <div className="row">
                                <div className="col">
                                    <input
                                    ...
                                    <button className="btn btn-primary btn-lg mb-5" id="submitButton" type="submit">
                                        Submit
                                    </button>
                                </div>
                                </div>
